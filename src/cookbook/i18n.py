...
_HEBREW: dict[str, str] = {
    ...
    "not_recipe": "לא מתכון",
    "reimport_source": "עדכון מקור מאינסטגרם",
    "reimport_source_loading": "מעדכן…",
    "reimport_source_failed": "לא ניתן לעדכן את המקור. נסו שוב.",
    "delete": "מחיקה",
    "cancel": "ביטול",
    "save": "שמירה",
...
_ENGLISH: dict[str, str] = {
    ...
    "reimport_source": "Refresh Instagram source",
    "reimport_source_loading": "Refreshing…",
    "reimport_source_failed": "Could not refresh the source. Try again.",
    "delete": "Delete",
    "cancel": "Cancel",
    "save": "Save",
